...
class UsersController extends BaseController {
  get router () {
    ...
    router.post('/users/change-employee-password', this.actionRunner(actions.UpdateUserPasswordAction))
    router.post('/users/bulk.update', this.actionRunner(actions.BulkUpdateUserAction))
    router.post('/users/bulk.delete', this.actionRunner(actions.BulkDeleteUserAction))
    return router
  }
